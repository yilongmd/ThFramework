...
@interface ThKeyValueStore()

@property (strong, nonatomic) FMDatabaseQueue * dbQueue;

@end

@implementation ThKeyValueStore
...
- (void)createTableWithName:(NSString *)tableName {
    if ([ThKeyValueStore checkTableName:tableName] == NO) {
        return;
    }
...
- (id)getObjectById:(NSString *)objectId fromTable:(NSString *)tableName {
    ThKeyValueItem * item = [self getYTKKeyValueItemById:objectId fromTable:tableName];
    if (item) {
...
- (ThKeyValueItem *)getYTKKeyValueItemById:(NSString *)objectId fromTable:(NSString *)tableName {
    if ([ThKeyValueStore checkTableName:tableName] == NO) {
        return nil;
    }
    ...
    if (json) {
        ...
        ThKeyValueItem * item = [[ThKeyValueItem alloc] init];
...
- (NSArray *)getAllItemsFromTable:(NSString *)tableName {
    ...
    NSError * error;
    for (ThKeyValueItem * item in result) {
        error = nil;
